...
jQuery(window).ready(function() {
    ...
    // Load Bootstrap JS
    loadScript('/assets/bootstrap/js/bootstrap.min.js', function() {
...
function _form() {
    ...
    if (jQuery('form.validate-plugin').length > 0) {
        ...
        loadScript('/assets/form.validate/jquery.form.min.js', function() {
            loadScript('/assets/form.validate/jquery.validation.min.js');
        });
    ...
    if (jQuery('form.validate').length > 0) {
        ...
        loadScript('/assets/form.validate/jquery.form.min.js', function() {
            loadScript('/assets/form.validate/jquery.validation.min.js', function() {
    ...
    if (_container.length > 0) {
        ...
        loadScript('/assets/form.masked/jquery.maskedinput.js', function() {
...
! function(n) {
    n.fn.parallax = function(n, t, e) {
        function o() {
            ...
            r = e ? function(n) { return n.outerHeight(!0) } : function(n) { return n.height() }, i.each(function() {
                var e = jQuery(this),
                    i = e.offset().top,
                    h = r(e);
        ...
        (arguments.length < 1 || null === n) && (n = "50%"), (arguments.length < 2 || null === t) && (t = .1), (arguments.length < 3 || null === e) && (e = !0), i.each(function() { u = i.offset().top, u < window.height && (u = 0) }), jQuery(window).bind("scroll", o).resize(o), o()
    }
}(jQuery);
...
! function(e, t, n) {
    ...
    function u() { var e = t.body; return e || (e = a(S ? "svg" : "body"), e.fake = !0), e }
    ...
    function h(t, r) {
        ...
        if ("CSSSupportsRule" in e) { for (var i = []; o--;) i.push("(" + m(t[o]) + ":" + r + ")"); return i = i.join(" or "), f("@supports (" + i + ") { #modernizr { position: absolute; } }", function(e) { return "absolute" == getComputedStyle(e, null).position }) }
        return n
    }

    function v(e, t, o, i) {
        function s() { f && (delete A.style, delete A.modElem) }
        if (i = r(i, "undefined") ? !1 : i, !r(o, "undefined")) { var u = h(e, o); if (!r(u, "undefined")) return u }
        for (var f, d, p, m, v, g = ["modernizr", "tspan", "samp"]; !A.style && g.length;) f = !0, A.modElem = a(g.shift()), A.style = A.modElem.style;
        for (p = e.length, d = 0; p > d; d++)
            if (m = e[d], v = A.style[m], c(m, "-") && (m = l(m)), A.style[m] !== n) { if (i || r(o, "undefined")) return s(), "pfx" == t ? m : !0; try { A.style[m] = o } catch (y) {} if (A.style[m] != v) return s(), "pfx" == t ? m : !0 }
        return s(), !1
    }
    ...
    S || ! function(e, t) {
        ...
        function o(e, t) { var n = C.elements; "string" != typeof n && (n = n.join(" ")), "string" != typeof e && (e = e.join(" ")), C.elements = n + " " + e, c(t) }
        ...
        function c(e) { e || (e = t); var r = i(e); return !C.shivCSS || u || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), f || l(e, r), e }
        var u, f, d = "3.7.3",
            p = e.html5 || {},
        ...
        ! function() {
            try {
                ...
                e.innerHTML = "<xyz></xyz>", u = "hidden" in e, f = 1 == e.childNodes.length || function() { t.createElement("a"); var e = t.createDocumentFragment(); return "undefined" == typeof e.cloneNode || "undefined" == typeof e.createDocumentFragment || "undefined" == typeof e.createElement }()
            } catch (n) { u = !0, f = !0 }
        }();
    ...
    ! function() {
        ...
        N = r(e, "undefined") || r(e.call, "undefined") ? function(e, t) { return t in e && r(e.constructor.prototype[t], "undefined") } : function(t, n) { return e.call(t, n) }
    }(), E._l = {}, E.on = function(e, t) { this._l[e] || (this._l[e] = []), this._l[e].push(t), Modernizr.hasOwnProperty(e) && setTimeout(function() { Modernizr._trigger(e, Modernizr[e]) }, 0) }, E._trigger = function(e, t) {
        if (this._l[e]) {
            var n = this._l[e];
            setTimeout(function() { var e, r; for (e = 0; e < n.length; e++)(r = n[e])(t) }, 0), delete this._l[e]
        }
    }, Modernizr._q.push(function() { E.addTest = s });
    ...
    var L = E.testStyles = f,
        $ = { elem: a("modernizr") };
    Modernizr._q.push(function() { delete $.elem });
    var A = { style: $.elem.style };
    Modernizr._q.unshift(function() { delete A.style });
    E.testProp = function(e, t, r) { return v([e], n, t, r) };
    E.testAllProps = g;
    E.prefixed = function(e, t, n) { return 0 === e.indexOf("@") ? F(e) : (-1 != e.indexOf("-") && (e = l(e)), t ? g(e, t, n) : g(e, "pfx")) };
    E.testAllProps = y, Modernizr.addTest("csstransitions", y("transition", "all", !0)), Modernizr.addTest("csstransforms3d", function() {
        ...
        if (e && (!t || "webkitPerspective" in w.style)) {
            ...
            Modernizr.supports ? n = "@supports (perspective: 1px)" : (n = "@media (transform-3d)", t && (n += ",(-webkit-transform-3d)")), n += "{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}", L(r + n, function(t) { e = 7 === t.offsetWidth && 18 === t.offsetHeight })
        }
        return e
